...
export default function MoreScreen() {
  ...
  async function deleteAccount() {
    ...
    try {
      ...
      Alert.alert(
        'Account deleted',
        'Your online sync account and its data were permanently deleted. Your Chron Bible progress and notes remain as a local-only copy on this phone.',
  ...
  function confirmDeletion() {
    Alert.alert(
      ...
      'First, the latest Chron Bible progress and notes will be saved on this phone. Then this permanently deletes the Google-linked sync account and its online data. The local copy will remain, but the deleted sync account cannot be restored. This cannot be undone.',
      [
