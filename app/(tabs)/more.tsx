...
const styles=StyleSheet.create({page:{flex:1,backgroundColor:colors.charcoal},content:{padding:20,paddingTop:52,gap:14,paddingBottom:100},title:{color:colors.text,fontSize:30,fontWeight:'900',marginBottom:8},whatsappCard:{backgroundColor:colors.panel2},cardTitle:{color:colors.gold,fontSize:18,fontWeight:'900',marginBottom:9},body:{color:colors.ivory,lineHeight:22,marginBottom:16}});
